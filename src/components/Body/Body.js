    ...
    render() { 
        ...
        <div>
            <div className = "bodyContainer">
                <div className="languageBar" ref={this.props.refSkills}>
                    <p>Javascript</p>
                    <p>Node.js</p>
                    <p>React.js</p>
                    <p>Redux</p>
